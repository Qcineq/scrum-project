                ...
                <div class="dashboard-content border-dashed p-3 m-4 view-height">
                    <div class="row border-bottom border-3 p-1 m-1">
                        ...
                        <div class="col d-flex justify-content-end mb-2 noPadding">
                            <button  form="firstForm" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Zapisz</button>
                        </div>
                    </div>

                    <div class="schedules-content">
                        <form id="firstForm" action="/app/recipe/plan/add" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" value="" id="number" placeholder="Numer posiłki" name="mealNumber">
                                </div>
                            </div>
                            <div class="form-group row">
